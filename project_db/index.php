	...
	<header id="head">
      ...
      <div class="heading-text">							
                    ...
                    <div class="camera_wrap camera_emboss pattern_1" id="camera_wrap_4">
                        <div data-thumb="assets/images/slides/thumbs/img4.jpg" data-src="assets/images/slides/img1.jpg">
                        </div> 
    ...
    <div class="row">
					<div class="col-md-12">
						<div class="grey-box-icon b4">  
							...
							<font size=4>Daftarkan diri anda dan jadilah penerus bangsa yang berkualitas!</font>
