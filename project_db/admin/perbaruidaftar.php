<?php
	...
	if(isset($_GET['simpan'])){
					...
					$query=oci_parse($conn, "UPDATE DATA_SISWA SET NAMA='$nama', JENIS_KELAMIN='$jk', ALAMAT='$alamat', ASAL_SEKOLAH='$asal', AGAMA='$agama', TEMPAT_LAHIR='$tpt_lahir', TANGGAL_LAHIR='$tgl_lahir', STATUS_ANAK='$status', NAMA_AYAH='$ayah', NAMA_IBU='$ibu', PENGHASILAN='$penghasilan', NO_TELEPON=$tlp, PEKERJAAN='$pekerjaan', NILAI_MAT=$mat, NILAI_IPA=$ipa, NILAI_ING=$ing, NILAI_BIN=$bin, NILAI_TOTAL=$total WHERE NIS=$nis");
...
<body>
    <div id="wrapper">
        ...
        <div class="container">
            <div id="main">
         <h4 class="modal-title" id="myModalLabel">Perbarui Data Pendaftar</h4>
        <div class="area-loading"></div>
      </div>
									
      <div class="modal-body">
         <form method="get" action="perbaruidaftar.php">
        <table class="table" width="100%">
									<tr>
											 				<th width="25%">NIS</th>
                <td width="1%"> : </td>
                <td> <input id="nis" name="nis" placeholder="Masukkan Nomor Induk Siswa yang ingin diperbarui" class="form-control" type="text"></td>
									</tr>
          <tr>
                <th width="25%">Nama </th>
                <td width="1%"> : </td>
        ...
        *) Foto ditempel sesudah anda mengisi semua formulir dengan benar<br>
        *) Jika anda anda bingung harap meminta bantuan panitia PSB <br>
        *) Dengan mengisi semua formulir anda akan menjadi calon siswa
